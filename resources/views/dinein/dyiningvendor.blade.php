...
<div class="offer-section py-3 resturant-banner">
    <div class="container position-relative">
        <div class="resturant-banner-inner" id="vendor-pic"></div>
    </div>
</div>
<div class="container">
...
<script type="text/javascript">
    ...
    async function getVendorDetails() {
        ...
        await vendorDetailsRef.get().then(async function (vendorSnapshots) {
            ...
            if (vendorDetails.hasOwnProperty('photo') && vendorDetails.photo != '') {
                $('#vendor-pic').html('<img alt="#" src="' + vendorDetails.photo + '" onerror="this.onerror=null;this.src=\'' + placeholderImageSrc + '\'" class="img-fluid item-img w-100">');
            } else {
                $('#vendor-pic').html('<img alt="#" src="' + placeholderImageSrc + '"  class="img-fluid item-img w-100">');
            }
    ...
    function buildRatingsAndReviewsHTML(reviewsSnapshots) {
        ...
        allreviewdata.forEach((listval) => {
            ...
            if (val.profile == '' || val.profile.indexOf('firebasestorage.googleapis.com') == -1) {
                ...
                try {
                    reviewhtml = reviewhtml + '<a href="javascript:void(0);"><img alt="#" src="' + val.profile + '" onerror="this.onerror=null;this.src=\'' + placeholderImageSrc + '\'" class="mr-3 rounded-pill"></a>';
                } catch (err) {
                    reviewhtml = reviewhtml + '<a href="javascript:void(0);"><img alt="#" src="' + placeholderImageSrc + '" class="mr-3 rounded-pill"></a>';
                }
            }
    ...
    function buildHTMLPopularVendor(popularRestauantSnapshot) {
        ...
        allPopulardata.forEach((listval) => {
            ...
            popularVendorHTML = popularVendorHTML + '<a href="' + view_vendor_details + '"><img alt="#" src="' + val.photo + '" onerror="this.onerror=null;this.src=\'' + placeholderImageSrc + '\'" class="img-fluid item-img w-100"></a></div><div class="p-3 position-relative"><div class="list-card-body"><h6 class="mb-1"><a href="' + view_vendor_details + '" class="text-black">' + val.title + '</a></h6><p class="text-gray mb-3"><span class="fa fa-map-marker"></span> ' + val.location + '</p>';
    ...
    function buildHTMLCouponList(couponListSnapshot) {
        ...
        alldata.forEach((listval) => {
            ...
            if (val.hasOwnProperty('image') && val.image != '') {
                html = html + '<img alt="#" src="' + val.image + '" onerror="this.onerror=null;this.src=\'' + placeholderImageSrc + '\'" class="img-fluid item-img w-100"></a></div><div class="p-3 position-relative"><div class="list-card-body">';
            } else {
