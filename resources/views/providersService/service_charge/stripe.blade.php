                                ...
                                <table class="payment-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right payment-buttons">
                                            <form action="<?php echo route('service-charge-stripe'); ?>" method="post">
                                                @csrf
...
<script type="text/javascript">
    ...
    function setOutcome(result) {
        ...
        if (result.token) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo route('service-charge-stripe'); ?>",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        window.location.href = '<?php echo route('service-charge-success'); ?>';
                    } else {
