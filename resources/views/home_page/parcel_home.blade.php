...
<script type="text/javascript">
    ...
    if ($("#parcel_category").html() == '') {
        var ref = database.collection('parcel_categories').where('publish', '==', true).orderBy("set_order", "asc");
        placeHolderImage().then(function (response) {
            ...
            ref.get().then(async function (snapshots) {
                ...
                snapshots.docs.forEach((section) => {
                    ...
                    html = '<div class="col-md-4 mb-4 parcel_category_details" data-id="' + datas.id + '"><div class="eh-are-box d-flex align-items-center p-3"><div class="par-img mr-5"><img src="' + parcel_image + '" onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" class="img-fluid"></div><div class="media-body"><h3>' + datas.title + '</h3></div></div></div>';
