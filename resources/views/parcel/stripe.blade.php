                ...
                <div>
                    <div class="siddhi-cart-item mb-3 rounded shadow-sm bg-white overflow-hidden">
                        <div class="siddhi-cart-item-profile bg-white p-3">
                                ...
                                <table class="payment-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right payment-buttons">
                                            <form action="<?php echo route('process_parcel_stripe'); ?>" method="post">
                                                @csrf
                            ...
                            <button type="submit">Pay $<?php echo $amount; ?></button>
                            <div class="outcome">
...
<script type="text/javascript">
    ...
    function setOutcome(result) {
        ...
        if (result.token) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo route('process_parcel_stripe'); ?>",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        window.location.href = '<?php echo route('parcel_success'); ?>';
                    } else {
