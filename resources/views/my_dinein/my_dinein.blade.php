...
<script type="text/javascript">
    ...
    function buildHTMLCompletedOrders(completedorderSnapshots) {
        ...
        alldata.forEach((listval) => {
            ...
            html = html + '<div class="pb-3"><div class="p-3 rounded shadow-sm bg-white"><div class="d-flex border-bottom pb-3 m-d-flex"><div class="text-muted mr-3"><img alt="#" src="' + orderRestaurantImage + '" onerror="this.onerror=null;this.src=\'' + place_holder_image + '\'" class="img-fluid order_img rounded"></div><div><p class="mb-0 font-weight-bold"><a href="' + view_vendor_details + '" class="text-dark">' + val.vendor.title + '</a></p><p class="mb-0"><span class="fa fa-map-marker"></span> ' + val.vendor.location + '</p><p>ORDER ' + val.id + '</p></div><div class="ml-auto ord-com-btn"><p class=" ' + statustext_class + ' text-white py-1 px-2 rounded small mb-1">' + statustext + '</p><p class="small font-weight-bold text-center"><i class="feather-clock"></i> ' + val.date.toDate().toDateString() + '<br/>' + val.date.toDate().toTimeString() + '</p></div></div>' + detailHTML + '<div class="d-flex pt-3 m-d-flex"><div class="small">';
